...
/******/ 	return __webpack_require__(__webpack_require__.s = "../../../packages-native/web-view/src/WebView.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "../../../packages-native/web-view/src/WebView.tsx":
/*!**********************************************************************************************************!*\
  !*** /Users/diego.antonelli/Desktop/projects/widgets-resources/packages-native/web-view/src/WebView.tsx ***!
  \**********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @native-mobile-resources/util-widgets */ "../../../packages-native/util-widgets/dist/index.js"), __webpack_require__(/*! react */ "react"), __webpack_require__(/*! react-native */ "react-native"), __webpack_require__(/*! react-native-webview */ "react-native-webview"), __webpack_require__(/*! ./ui/Styles */ "../../../packages-native/web-view/src/ui/Styles.ts"), __webpack_require__(/*! @widgets-resources/piw-utils */ "../../piw-utils/dist/index.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, util_widgets_1, react_1, react_native_1, react_native_webview_1, Styles_1, piw_utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var WebView = (function (_super) {
        ...
        function WebView() {
            ...
            _this.styles = util_widgets_1.flattenStyles(Styles_1.defaultWebViewStyle, _this.props.style);
            return _this;
        }
        WebView.prototype.render = function () {
            var uri = this.props.url && this.props.url.value;
            var html = this.props.content && this.props.content.value;
            if (!uri && !html) {
                return (react_1.createElement(react_native_1.View, { style: this.styles.errorContainer },
                    react_1.createElement(react_native_1.Text, { style: this.styles.errorText }, "No URL or content was provided.")));
            }
            return (react_1.createElement(react_native_1.View, { style: this.styles.container },
                react_1.createElement(react_native_webview_1.WebView, { testID: this.props.name, source: html ? { html: html } : { uri: uri }, style: {
                        width: "100%",
                        height: "100%"
                    }, onLoad: this.onLoadHandler, onError: this.onErrorHandler, userAgent: this.props.userAgent })));
        };
        WebView.prototype.onLoad = function () {
            piw_utils_1.executeAction(this.props.onLoad);
        };
        WebView.prototype.onError = function () {
            piw_utils_1.executeAction(this.props.onError);
        };
        return WebView;
    }(react_1.Component));
...
/***/ "../../../packages-native/web-view/src/ui/Styles.ts":
/*!***********************************************************************************************************!*\
  !*** /Users/diego.antonelli/Desktop/projects/widgets-resources/packages-native/web-view/src/ui/Styles.ts ***!
  \***********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
