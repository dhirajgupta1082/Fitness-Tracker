...
/******/ 	return __webpack_require__(__webpack_require__.s = "../../../packages-native/progress-bar/src/ProgressBar.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "../../../packages-native/progress-bar/src/ProgressBar.tsx":
/*!******************************************************************************************************************!*\
  !*** /Users/diego.antonelli/Desktop/projects/widgets-resources/packages-native/progress-bar/src/ProgressBar.tsx ***!
  \******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @native-mobile-resources/util-widgets */ "../../../packages-native/util-widgets/dist/index.js"), __webpack_require__(/*! @widgets-resources/piw-utils */ "../../piw-utils/dist/index.js"), __webpack_require__(/*! react */ "react"), __webpack_require__(/*! react-native */ "react-native"), __webpack_require__(/*! react-native-progress */ "../../../node_modules/react-native-progress/index.js"), __webpack_require__(/*! ./ui/Styles */ "../../../packages-native/progress-bar/src/ui/Styles.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, util_widgets_1, piw_utils_1, react_1, react_native_1, react_native_progress_1, Styles_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function ProgressBar(props) {
        var styles = util_widgets_1.flattenStyles(Styles_1.defaultProgressBarStyle, props.style);
        var validate = function () {
            var messages = [];
            var minimumValue = props.minimumValue, maximumValue = props.maximumValue, progressValue = props.progressValue;
            if (!piw_utils_1.isAvailable(minimumValue)) {
                messages.push("No minimum value provided.");
            }
            if (!piw_utils_1.isAvailable(maximumValue)) {
                messages.push("No maximum value provided.");
            }
            if (!piw_utils_1.isAvailable(progressValue)) {
        ...
        var calculateProgress = function () {
            var minimumValue = props.minimumValue, maximumValue = props.maximumValue, progressValue = props.progressValue;
            if (!piw_utils_1.isAvailable(minimumValue) ||
                !piw_utils_1.isAvailable(maximumValue) ||
                !piw_utils_1.isAvailable(progressValue) ||
        ...
        return (react_1.createElement(react_native_1.View, { style: styles.container },
            react_1.createElement(react_native_progress_1.Bar, { testID: props.name, height: Number(styles.bar.height), width: null, progress: progress, color: styles.fill.backgroundColor, borderWidth: styles.bar.borderWidth, style: styles.bar }),
            validationMessages.length > 0 && (react_1.createElement(react_native_1.Text, { style: styles.validationMessage }, validationMessages.join("\n")))));
    }
...
/***/ "../../../packages-native/progress-bar/src/ui/Styles.ts":
/*!***************************************************************************************************************!*\
  !*** /Users/diego.antonelli/Desktop/projects/widgets-resources/packages-native/progress-bar/src/ui/Styles.ts ***!
  \***************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! react-native */ "react-native")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, react_native_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.defaultProgressBarStyle = {
        container: {},
        bar: __assign({ height: 6 }, react_native_1.Platform.select({
            ios: {
                borderWidth: 1,
                borderRadius: 4,
