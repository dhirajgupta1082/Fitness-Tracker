...
/******/ 	return __webpack_require__(__webpack_require__.s = "../../../packages-native/listview-swipe/src/ListViewSwipe.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "../../../packages-native/listview-swipe/src/ListViewSwipe.tsx":
/*!**********************************************************************************************************************!*\
  !*** /Users/diego.antonelli/Desktop/projects/widgets-resources/packages-native/listview-swipe/src/ListViewSwipe.tsx ***!
  \**********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! react */ "react"), __webpack_require__(/*! @native-mobile-resources/util-widgets */ "../../../packages-native/util-widgets/dist/index.js"), __webpack_require__(/*! react-native */ "react-native"), __webpack_require__(/*! react-native-gesture-handler */ "react-native-gesture-handler"), __webpack_require__(/*! react-native-gesture-handler/Swipeable */ "react-native-gesture-handler/Swipeable"), __webpack_require__(/*! ./ui/styles */ "../../../packages-native/listview-swipe/src/ui/styles.ts"), __webpack_require__(/*! @widgets-resources/piw-utils */ "../../piw-utils/dist/index.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, react_1, util_widgets_1, react_native_1, react_native_gesture_handler_1, Swipeable_1, styles_1, piw_utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Swipeable_1 = __importDefault(Swipeable_1);
    exports.ListViewSwipe = function (props) {
        var row = react_1.useRef(null);
        var styles = util_widgets_1.flattenStyles(styles_1.defaultListViewSwipeStyle, props.style);
        var _a = react_1.useState(new react_native_1.Animated.Value(0)), animation = _a[0], setAnimation = _a[1];
        var _b = react_1.useState(false), animate = _b[0], setAnimate = _b[1];
        var isLeftSideAction = props.leftRenderMode !== "buttons";
        var isRightSideAction = props.rightRenderMode !== "buttons";
        var isLeftDisabled = props.leftRenderMode === "disabled";
        var isRightDisabled = props.rightRenderMode === "disabled";
        var isLeftToggle = props.leftRenderMode === "toggle";
        var isRightToggle = props.rightRenderMode === "toggle";
        var setAnimationDefinitions = react_1.useCallback(function (event) {
            setAnimation(new react_native_1.Animated.Value(event.nativeEvent.layout.height));
        }, []);
        var renderLeftActions = function () {
            if (isLeftDisabled) {
                return undefined;
            }
        ...
        var renderRightActions = function () {
            if (isRightDisabled) {
                return undefined;
            }
        ...
        var renderAction = function (style, content, isToggle, testID) {
            var panelSize = style.panelSize, normalStyle = __rest(style, ["panelSize"]);
            delete normalStyle.threshold;
            return (react_1.createElement(react_native_gesture_handler_1.RectButton, { style: [normalStyle, isToggle && { flex: 0, width: panelSize }], onPress: close, testID: props.name + "$" + testID }, content));
        };
        var renderButtons = function (style, content, testID) {
            var panelSize = style.panelSize, normalStyle = __rest(style, ["panelSize"]);
            delete normalStyle.threshold;
            return (react_1.createElement(react_native_1.View, { style: { width: panelSize, flexDirection: "row" }, testID: props.name + "$" + testID },
                react_1.createElement(react_native_1.View, { style: normalStyle }, content)));
        };
        var onSwipeLeft = react_1.useCallback(function () {
            performAnimation(props.leftRenderMode, props.onSwipeLeft);
        }, [animation]);
        var onSwipeRight = react_1.useCallback(function () {
            performAnimation(props.rightRenderMode, props.onSwipeRight);
        }, [animation]);
        var performAnimation = react_1.useCallback(function (renderMode, action) {
        ...
        return (react_1.createElement(react_native_1.Animated.View, { style: animate ? { height: animation } : {} },
            react_1.createElement(Swipeable_1.default, { ref: row, friction: 1, leftThreshold: styles.leftAction.threshold ? styles.leftAction.threshold : isLeftSideAction ? 100 : 40, rightThreshold: styles.rightAction.threshold ? styles.rightAction.threshold : isRightSideAction ? 100 : 40, renderLeftActions: renderLeftActions, renderRightActions: renderRightActions, onSwipeableLeftOpen: onSwipeLeft, onSwipeableRightOpen: onSwipeRight, overshootLeft: false, overshootRight: false, useNativeAnimations: true },
                react_1.createElement(react_native_1.View, { style: styles.container, onLayout: setAnimationDefinitions, testID: props.name }, props.content))));
    };
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
/***/ "../../../packages-native/listview-swipe/src/ui/styles.ts":
/*!*****************************************************************************************************************!*\
  !*** /Users/diego.antonelli/Desktop/projects/widgets-resources/packages-native/listview-swipe/src/ui/styles.ts ***!
  \*****************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.defaultListViewSwipeStyle = {
        container: {
            flex: 1,
            alignItems: "stretch",
...
/*!*********************************************************!*\
  !*** external "react-native-gesture-handler/Swipeable" ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = require("react-native-gesture-handler/Swipeable");

/***/ })

/******/ });
//# sourceMappingURL=ListViewSwipe.js.map