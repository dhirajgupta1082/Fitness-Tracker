...
/******/ 	return __webpack_require__(__webpack_require__.s = "../../../packages-native/video-player/src/VideoPlayer.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "../../../packages-native/video-player/src/VideoPlayer.tsx":
/*!******************************************************************************************************************!*\
  !*** /Users/diego.antonelli/Desktop/projects/widgets-resources/packages-native/video-player/src/VideoPlayer.tsx ***!
  \******************************************************************************************************************/
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @native-mobile-resources/util-widgets */ "../../../packages-native/util-widgets/dist/index.js"), __webpack_require__(/*! react */ "react"), __webpack_require__(/*! react-native */ "react-native"), __webpack_require__(/*! react-native-video */ "react-native-video"), __webpack_require__(/*! ./ui/Styles */ "../../../packages-native/video-player/src/ui/Styles.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, util_widgets_1, react_1, react_native_1, react_native_video_1, Styles_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    react_native_video_1 = __importDefault(react_native_video_1);
    var VideoPlayer = (function (_super) {
        ...
        function VideoPlayer() {
            ...
            _this.onLoadStartHandler = _this.onLoadStart.bind(_this);
            _this.onLoadHandler = _this.onLoad.bind(_this);
            _this.onErrorHandler = _this.onError.bind(_this);
            _this.styles = util_widgets_1.flattenStyles(Styles_1.defaultVideoStyle, _this.props.style);
            return _this;
        }
        VideoPlayer.prototype.render = function () {
            var uri = this.props.videoUrl && this.props.videoUrl.value;
            var styles = __assign({}, this.styles.container);
            if (this.props.aspectRatio && this.state.aspectRatio) {
                styles.aspectRatio = this.state.aspectRatio;
            }
            return (react_1.createElement(react_native_1.View, { style: styles },
                this.state.status === "loading" && (react_1.createElement(react_native_1.ActivityIndicator, { color: this.styles.indicator.color, size: "large" })),
                this.state.status === "error" && (react_1.createElement(react_native_1.Text, { style: this.styles.errorMessage }, "The video failed to load :(")),
                react_1.createElement(react_native_video_1.default, { testID: this.props.name, source: { uri: uri }, paused: !this.props.autoStart, muted: this.props.muted, repeat: this.props.loop, controls: this.props.showControls, onLoadStart: this.onLoadStartHandler, onLoad: this.onLoadHandler, onError: this.onErrorHandler, style: this.state.status !== "ready" ? { height: 0 } : this.styles.video, useTextureView: false, resizeMode: "contain" })));
        };
        VideoPlayer.prototype.onLoadStart = function () {
            this.setState({ status: "loading", aspectRatio: undefined });
        };
        VideoPlayer.prototype.onLoad = function (data) {
            this.setState({ status: "ready", aspectRatio: data.naturalSize.width / data.naturalSize.height });
        };
        VideoPlayer.prototype.onError = function () {
            this.setState({ status: "error", aspectRatio: undefined });
        };
        return VideoPlayer;
    }(react_1.Component));
...
/***/ "../../../packages-native/video-player/src/ui/Styles.ts":
/*!***************************************************************************************************************!*\
  !*** /Users/diego.antonelli/Desktop/projects/widgets-resources/packages-native/video-player/src/ui/Styles.ts ***!
  \***************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
