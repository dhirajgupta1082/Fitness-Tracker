...
/******/ 	return __webpack_require__(__webpack_require__.s = "../../../packages-native/badge/src/Badge.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "../../../packages-native/badge/src/Badge.tsx":
/*!*****************************************************************************************************!*\
  !*** /Users/diego.antonelli/Desktop/projects/widgets-resources/packages-native/badge/src/Badge.tsx ***!
  \*****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @native-mobile-resources/util-widgets */ "../../../packages-native/util-widgets/dist/index.js"), __webpack_require__(/*! react */ "react"), __webpack_require__(/*! react-native */ "react-native"), __webpack_require__(/*! ./ui/Styles */ "../../../packages-native/badge/src/ui/Styles.ts"), __webpack_require__(/*! @widgets-resources/piw-utils */ "../../piw-utils/dist/index.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, util_widgets_1, react_1, react_native_1, Styles_1, piw_utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Badge = (function (_super) {
        ...
        function Badge() {
            ...
            _this.onClickHandler = _this.onClick.bind(_this);
            _this.styles = util_widgets_1.flattenStyles(Styles_1.defaultBadgeStyle, _this.props.style);
            return _this;
        }
        Badge.prototype.render = function () {
            var isAndroid = react_native_1.Platform.OS === "android";
            return (react_1.createElement(react_native_1.View, { style: this.styles.container, testID: this.props.name }, this.props.onClick ? (isAndroid ? (react_1.createElement(react_native_1.TouchableNativeFeedback, { background: react_native_1.TouchableNativeFeedback.SelectableBackgroundBorderless(), onPress: this.onClickHandler }, this.renderText())) : (react_1.createElement(react_native_1.TouchableOpacity, { onPress: this.onClickHandler }, this.renderText()))) : (this.renderText())));
        };
        Badge.prototype.renderText = function () {
            var value = this.props.caption.value || "";
            return (react_1.createElement(react_native_1.Text, { testID: this.props.name + "$caption", style: this.styles.caption }, value));
        };
        Badge.prototype.onClick = function () {
...
/***/ "../../../packages-native/badge/src/ui/Styles.ts":
/*!********************************************************************************************************!*\
  !*** /Users/diego.antonelli/Desktop/projects/widgets-resources/packages-native/badge/src/ui/Styles.ts ***!
  \********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
