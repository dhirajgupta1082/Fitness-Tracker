...
/******/ 	return __webpack_require__(__webpack_require__.s = "../../../packages-native/range-slider/src/RangeSlider.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "../../../packages-native/range-slider/src/Marker.tsx":
/*!*************************************************************************************************************!*\
  !*** /Users/diego.antonelli/Desktop/projects/widgets-resources/packages-native/range-slider/src/Marker.tsx ***!
  \*************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../packages-native/range-slider/src/RangeSlider.tsx":
/*!******************************************************************************************************************!*\
  !*** /Users/diego.antonelli/Desktop/projects/widgets-resources/packages-native/range-slider/src/RangeSlider.tsx ***!
  \******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @native-mobile-resources/util-widgets */ "../../../packages-native/util-widgets/dist/index.js"), __webpack_require__(/*! @ptomasroos/react-native-multi-slider */ "../../../node_modules/@ptomasroos/react-native-multi-slider/MultiSlider.js"), __webpack_require__(/*! react */ "react"), __webpack_require__(/*! react-native */ "react-native"), __webpack_require__(/*! big.js */ "big.js"), __webpack_require__(/*! ./Marker */ "../../../packages-native/range-slider/src/Marker.tsx"), __webpack_require__(/*! ./ui/Styles */ "../../../packages-native/range-slider/src/ui/Styles.ts"), __webpack_require__(/*! @widgets-resources/piw-utils */ "../../piw-utils/dist/index.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, util_widgets_1, react_native_multi_slider_1, react_1, react_native_1, big_js_1, Marker_1, Styles_1, piw_utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var RangeSlider = (function (_super) {
        ...
        function RangeSlider() {
            ...
            _this.styles = util_widgets_1.flattenStyles(Styles_1.defaultRangeSliderStyle, _this.props.style);
            _this.lastLowerValue = util_widgets_1.toNumber(_this.props.lowerValueAttribute);
            _this.lastUpperValue = util_widgets_1.toNumber(_this.props.upperValueAttribute);
            return _this;
        }
        RangeSlider.prototype.render = function () {
            var _this = this;
            var lowerValue = util_widgets_1.toNumber(this.props.lowerValueAttribute);
            var upperValue = util_widgets_1.toNumber(this.props.upperValueAttribute);
            var validationMessages = this.validate();
            var validProps = validationMessages.length === 0;
            var editable = this.props.editable !== "never" && validProps;
            var enabledOne = editable && lowerValue != null && !this.props.lowerValueAttribute.readOnly;
            var enabledTwo = editable && upperValue != null && !this.props.upperValueAttribute.readOnly;
            var customMarker = function (markerEnabled, testID) { return function (props) { return (react_1.createElement(Marker_1.Marker, __assign({}, props, { markerStyle: markerEnabled ? props.markerStyle : _this.styles.markerDisabled, testID: _this.props.name + "$" + testID }))); }; };
            return (react_1.createElement(react_native_1.View, { onLayout: this.onLayoutHandler, style: this.styles.container, testID: this.props.name },
                react_1.createElement(react_native_multi_slider_1.default, { values: lowerValue != null && upperValue != null ? [lowerValue, upperValue] : undefined, min: validProps ? util_widgets_1.toNumber(this.props.minimumValue) : undefined, max: validProps ? util_widgets_1.toNumber(this.props.maximumValue) : undefined, step: validProps ? util_widgets_1.toNumber(this.props.stepSize) : undefined, enabledOne: enabledOne, enabledTwo: enabledTwo, markerStyle: this.styles.marker, trackStyle: enabledOne || enabledTwo ? this.styles.track : this.styles.trackDisabled, selectedStyle: enabledOne || enabledTwo ? this.styles.highlight : this.styles.highlightDisabled, pressedMarkerStyle: this.styles.markerActive, onValuesChange: this.onSlideHandler, onValuesChangeFinish: this.onChangeHandler, sliderLength: this.state.width, isMarkersSeparated: true, customMarkerLeft: customMarker(enabledOne, "leftMarker"), customMarkerRight: customMarker(enabledTwo, "rightMarker") }),
                this.props.lowerValueAttribute.validation && (react_1.createElement(react_native_1.Text, { style: this.styles.validationMessage }, this.props.lowerValueAttribute.validation)),
                this.props.upperValueAttribute.validation && (react_1.createElement(react_native_1.Text, { style: this.styles.validationMessage }, this.props.upperValueAttribute.validation)),
        ...
        RangeSlider.prototype.onLayout = function (event) {
            this.setState({
                width: event.nativeEvent.layout.width
            });
        };
        RangeSlider.prototype.onSlide = function (values) {
            this.props.lowerValueAttribute.setValue(new big_js_1.Big(values[0]));
            this.props.upperValueAttribute.setValue(new big_js_1.Big(values[1]));
        };
        RangeSlider.prototype.onChange = function (values) {
        ...
        RangeSlider.prototype.validate = function () {
            var messages = [];
            var _a = this.props, minimumValue = _a.minimumValue, maximumValue = _a.maximumValue, stepSize = _a.stepSize, lowerValueAttribute = _a.lowerValueAttribute, upperValueAttribute = _a.upperValueAttribute;
            ...
            if (util_widgets_1.unavailable(lowerValueAttribute)) {
                messages.push("The lower value attribute is not available.");
            }
            if (util_widgets_1.unavailable(upperValueAttribute)) {
                messages.push("The upper value attribute is not available.");
            }
            if (util_widgets_1.available(minimumValue) &&
                util_widgets_1.available(maximumValue) &&
                util_widgets_1.available(stepSize) &&
                util_widgets_1.available(lowerValueAttribute) &&
                util_widgets_1.available(upperValueAttribute)) {
...
/***/ "../../../packages-native/range-slider/src/ui/Styles.ts":
/*!***************************************************************************************************************!*\
  !*** /Users/diego.antonelli/Desktop/projects/widgets-resources/packages-native/range-slider/src/ui/Styles.ts ***!
  \***************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! react-native */ "react-native")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, react_native_1) {
    ...
    exports.defaultRangeSliderStyle = {
        container: {},
        track: {
