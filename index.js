...
import { navigationStyle } from "C:/Users/abc/Documents/Mendix/New folder/theme/styles.js";
...
startApp({
    ...
    "getTabs": () => ( [
        ...
        {
            "pageName": "NativeMobile.UserProfile",
            "caption": t( [
                "Profile"
            ] ),
            "icon": {
    ...
    "onStartupNativeClient": () => {
        NativeUI.registerPage("NativeMobile.Home_Native", require("C:/Users/abc/Documents/Mendix/New folder/deployment/native/pages/NativeMobile.Home_Native"), {"sidebar":false,"showBottomBar":true,"type":"Default"});
        NativeUI.registerPage("NativeMobile.Run_NewEdit", require("C:/Users/abc/Documents/Mendix/New folder/deployment/native/pages/NativeMobile.Run_NewEdit"), {"sidebar":false,"headerRegionName":"placeholder$Header","showBottomBar":true,"type":"Default"});
        NativeUI.registerPage("NativeMobile.Run_MapView", require("C:/Users/abc/Documents/Mendix/New folder/deployment/native/pages/NativeMobile.Run_MapView"), {"sidebar":false,"showBottomBar":false,"type":"Default"});
        NativeUI.registerPage("NativeMobile.Account_View", require("C:/Users/abc/Documents/Mendix/New folder/deployment/native/pages/NativeMobile.Account_View"), {"sidebar":false,"headerRegionName":"placeholder$Header","showBottomBar":true,"type":"Default"});
        NativeUI.registerPage("NativeMobile.UserProfile", require("C:/Users/abc/Documents/Mendix/New folder/deployment/native/pages/NativeMobile.UserProfile"), {"sidebar":false,"headerRegionName":"placeholder$Header","showBottomBar":true,"type":"Default"});
        NativeUI.registerPage("NativeMobile.Login", require("C:/Users/abc/Documents/Mendix/New folder/deployment/native/pages/NativeMobile.Login"), {"sidebar":false,"showBottomBar":false,"type":"Default"});
        NativeUI.registerPage("NativeMobile.SignUp", require("C:/Users/abc/Documents/Mendix/New folder/deployment/native/pages/NativeMobile.SignUp"), {"sidebar":false,"headerRegionName":"placeholder$Header","showBottomBar":true,"type":"Default"});
    }
});